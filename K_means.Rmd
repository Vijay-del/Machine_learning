...
# Cluster 1("Below Average Uni.")         |    Cluster 2("Above Average Uni.")   |   Cluster 3("Average Uni.")
# ----------------------------------------|--------------------------------------|-----------------------------
...
#   very less no.of new students enrolled | High in.state tution                 | High no.of new stud. enrolled
...
uni1<-Universities[Universities$`College Name`=="Tufts University",]
View(uni1)
uni1$`# PT undergrad`<-mean(Universities$`# PT undergrad`,na.rm=TRUE)
uni2<-rbind(uni,uni1)
View(uni2)
